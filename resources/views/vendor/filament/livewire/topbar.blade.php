<div class="fi-topbar-ctn">
    ...
    <nav class="fi-topbar">
        ...
        <div
            ...
            class="fi-topbar-end"
        >
            {{-- Insert the animated theme toggle left of the search bar --}}
            <div style="display:inline-flex;align-items:center;margin-right:0.5rem">{!! view('filament.components.theme-toggle')->render() !!}</div>
